...
<ul class="cl-effect-16">
						...
						<li><a href="contact.php" data-hover="CONTACT">Tips and Features</a></li>
					</ul>
					<!-- script-for-nav -->
					<script>
	...
	<div class="login">
		<div class="login-grids">
			<div class="col-md-6 log">
					 ...
					 <p>If you have previously Login with us, <a href="home.php">click here</a></p>
